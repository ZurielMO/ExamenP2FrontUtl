      ...
      <main className="row flex-grow-1">
        ...
        <div className="col-12 col-lg-6 p-0">
          ...
          <img 
            ...
            onError={(e) => {
              e.target.onerror = null;
              e.target.src = "data:image/svg+xml;charset=UTF-8,%3Csvg xmlns='http://www.w3.org/2000/svg' width='600' height='500' viewBox='0 0 600 500'%3E%3Crect width='600' height='500' fill='%23173b5f'/%3E%3Ctext x='50%25' y='50%25' dominant-baseline='middle' text-anchor='middle' fill='white' font-family='Arial' font-size='18'%3EImagen Congreso TI%3C/text%3E%3C/svg%3E"
            }}
          />
        </div>
      </main>
